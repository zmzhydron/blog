...
var fsreader = require('./widgets/fsreader.js');

// const mongodb = require('./mongodb/mongoss.js');
...
app.static('/resource/javascript/');
app.static('/resource/pages/');
app.static('/resource/javascript/163redux/');
// app.static('/resource/');
app.static('/resource/css/');
